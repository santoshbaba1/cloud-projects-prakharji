...
and a **DynamoDB** table. Where [Project 1](../api-gateway-rest-lambda/README.md) used a REST
...
> Project 1 or [lambda-basics](../lambda-basics/README.md)). Steps 5–7 are the
> intermediate deployment strategies. Recommended: do
> [api-gateway-rest-lambda](../api-gateway-rest-lambda/README.md) first and compare.
...
| Recommended first | [api-gateway-rest-lambda](../api-gateway-rest-lambda/README.md) |
...
- Compare notes with [Project 1](../api-gateway-rest-lambda/README.md): which deploy felt cleaner?
