...
> Project 2 ([api-gateway-http-dynamodb-crud](../api-gateway-http-dynamodb-crud/README.md))
...
| New to Lambda? | Do [lambda-basics](../lambda-basics/README.md) first |
...
- Build the twin: [api-gateway-http-dynamodb-crud](../api-gateway-http-dynamodb-crud/README.md) — same deployment strategies, done at the Lambda-alias level on an HTTP API with real state
