...
| Recommended first | [Lambda on a Schedule with EventBridge](../lambda-eventbridge-scheduled/README.md) for the scheduling pattern |
...
- [RDS Disaster Recovery](../rds-disaster-recovery/README.md) — the **recovery** half of the
  series: snapshots, point-in-time restore, cross-region copy, and a read-replica failover drill
- [Scheduled EC2 Start/Stop](../lambda-ec2-start-stop-scheduler/README.md) — a complementary
