...
> **Intermediate.** Helpful first: [rds-disaster-recovery](../rds-disaster-recovery/README.md)
> (RDS, PyMySQL, RPO/RTO) and [ec2-vpc-monitored-webapp](../ec2-vpc-monitored-webapp/README.md)
...
durability and HA. See the [concepts notes](../concepts/concepts.md) on high availability and
...
> [serverless](../monolith-to-serverless-migration/README.md) and
> [microservices](../monolith-to-microservices-eks/README.md). Those change the architecture;
...
| Region | **us-east-1** |
| Recommended first | [rds-disaster-recovery](../rds-disaster-recovery/README.md) |
