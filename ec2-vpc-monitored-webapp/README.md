...
[serverless-monitored-webapp](../serverless-monitored-webapp/README.md), runs the **same
...
- Run the **[serverless companion](../serverless-monitored-webapp/README.md)** and compare cost, ops burden, and scaling behaviour
