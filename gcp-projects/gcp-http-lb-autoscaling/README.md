...
[beginner VPC & Firewall project](../gcp-vpc-firewall-basics/README.md) first — this one assumes
...
| Requirement | Details |
|-------------|---------|
| gcloud CLI | Installed & authenticated — see the [beginner project's Step 1](../gcp-vpc-firewall-basics/steps/01-install-gcloud.md) |
...
- Compare with the AWS equivalent in this repo:
  [ec2-vpc-monitored-webapp](../../ec2-vpc-monitored-webapp/README.md) (ALB + Auto Scaling Group).
