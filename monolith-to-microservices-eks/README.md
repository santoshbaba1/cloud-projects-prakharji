...
(see [ecs-fargate-basics](../ecs-fargate-basics/README.md)). Then you decompose it into **three
...
As in the [serverless migration](../monolith-to-serverless-migration/README.md), you don't do a
...
> **Intermediate → Advanced.** Helpful first: [ecs-fargate-basics](../ecs-fargate-basics/README.md)
> (containers/ECR) and [k8s-optimization-and-recovery](../k8s-optimization-and-recovery/README.md)
...
releases. See the [concepts notes](../concepts/concepts.md) on scalability and fault tolerance.
...
> Same family as [Project 1 (serverless)](../monolith-to-serverless-migration/README.md) — both
> Refactors — but the target differs: **functions** there, **containers on Kubernetes** here.
> [Project 3 (DMS)](../database-migration-dms/README.md) is a **Replatform** instead.
...
| Region | **us-east-1** |
| Recommended first | [ecs-fargate-basics](../ecs-fargate-basics/README.md), [k8s-optimization-and-recovery](../k8s-optimization-and-recovery/README.md) |
...
the same trade-off [k8s-optimization-and-recovery](../k8s-optimization-and-recovery/README.md)
