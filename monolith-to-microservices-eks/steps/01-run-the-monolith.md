...
[ecs-fargate-basics](../../ecs-fargate-basics/README.md). For this step, a local container is
...
> Fargate task (reuse [ecs-fargate-basics](../../ecs-fargate-basics/README.md)). That's the true
