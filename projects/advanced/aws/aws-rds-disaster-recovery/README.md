...
- [Kubernetes Optimization & Recovery](../../../intermediate/kubernetes/k8s-optimization-and-recovery/README.md) — Project 3:
  apply both halves of this series to a Kubernetes app (resource limits + Velero backup/restore)
- [Serverless Monitored Web App](../../../intermediate/aws/aws-serverless-monitored-webapp/README.md) — pair durable RDS
