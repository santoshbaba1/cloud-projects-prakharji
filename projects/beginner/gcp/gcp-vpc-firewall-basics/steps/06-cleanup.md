...
> [intermediate project](../../../../intermediate/gcp/gcp-http-lb-autoscaling/README.md). Only the network resources above
> need deleting.
...
[intermediate load-balancing project](../../../../intermediate/gcp/gcp-http-lb-autoscaling/README.md).
