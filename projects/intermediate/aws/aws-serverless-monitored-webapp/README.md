...
[ec2-vpc-monitored-webapp](../../../advanced/aws/aws-ec2-vpc-monitored-webapp/README.md) project. It runs the
...
| Completed (recommended) | [EC2 + VPC Monitored Web App](../../../advanced/aws/aws-ec2-vpc-monitored-webapp/README.md) — so you can compare |
