...
> - [api-gateway-rest-lambda](../aws-api-gateway-rest-lambda/README.md) — REST API, includes API
>   Gateway's **native gateway-level canary release**
> - [api-gateway-http-dynamodb-crud](../aws-api-gateway-dynamodb-crud/README.md) — HTTP API
...
[api-gateway-rest-lambda](../aws-api-gateway-rest-lambda/README.md). This project's HTTP API does
canary at the alias.
...
[api-gateway-http-dynamodb-crud](../aws-api-gateway-dynamodb-crud/steps/07-blue-green-deployment.md)
